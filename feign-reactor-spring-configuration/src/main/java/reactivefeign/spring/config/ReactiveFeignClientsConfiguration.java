...
public class ReactiveFeignClientsConfiguration {
	...
	public Contract reactiveFeignContract(
			List<AnnotatedParameterProcessor> parameterProcessors, @Qualifier(value = "feign-conversion") FormattingConversionService feignConversionService) {
		return new SpringMvcContract(parameterProcessors, feignConversionService);
	}

//	@Bean(name = "feign-meter-reactive-logger")
//	@ConditionalOnMissingBean
