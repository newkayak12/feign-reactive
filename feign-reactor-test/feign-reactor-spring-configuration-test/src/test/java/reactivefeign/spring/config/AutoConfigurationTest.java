...
public class AutoConfigurationTest {
	...
	@ReactiveFeignClient(name = TEST_FEIGN_CLIENT,
			configuration = RequestInterceptorConfiguration.class, url = "localhost:${"+MOCK_SERVER_PORT_PROPERTY+"}", qualifier = TEST_FEIGN_CLIENT)
	public interface TestReactiveFeignClient {
		@GetMapping(path = TEST_URL)
		Mono<String> testMethod();
	}

	@ReactiveFeignClient(name = TEST_FEIGN_CLIENT_W_PATH_PARAM, path = "test/{id}", url = "localhost:${"+MOCK_SERVER_PORT_PROPERTY+"}" , qualifier = TEST_FEIGN_CLIENT_W_PATH_PARAM)
	...
	@ReactiveFeignClient(name = TEST_FEIGN_CLIENT_W_QUERY_PARAM, path = "/test"+TEST_URL, url = "localhost:${"+MOCK_SERVER_PORT_PROPERTY+"}" , qualifier = TEST_FEIGN_CLIENT_W_QUERY_PARAM)
